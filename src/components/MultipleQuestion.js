    ...
    render() {
      return (
        <Content style={commonStyle.container}>
          ...
          <TouchableOpacity activeOpacity={opacity} style={commonStyle.button} onPress={()=>this.props.click(2)}>
                <LinearGradient
                    colors={this.props.buttonStyle2}
                    style={{ width: "100%", padding: 15, alignItems: 'center', borderRadius: 5 }}>
                      <Text style={commonStyle.buttonText}>{this.props.answers[2]}</Text>
                </LinearGradient>    
          </TouchableOpacity>

          <TouchableOpacity activeOpacity={opacity} style={commonStyle.button} onPress={()=>this.props.click(3)}>
                <LinearGradient
                    colors={this.props.buttonStyle3}
                    style={{ width: "100%", padding: 15, alignItems: 'center', borderRadius: 5}}>
                      <Text style={commonStyle.buttonText}>{this.props.answers[3]}</Text>
                </LinearGradient>             
          </TouchableOpacity>
